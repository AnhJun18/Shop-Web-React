        ...
        <div id="template-mo-zay-hero-carousel" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <div class="container">
                        <div class="row p-5">
                            <img src="https://theme.hstatic.net/200000305259/1000963148/14/slide_index_2.jpg?v=74" alt=""/>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    <div class="container">
                        <div class="row p-5">
                            <img src="https://theme.hstatic.net/200000305259/1000963148/14/slide_index_1.jpg?v=74" alt=""/>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="container py-5">
            <div class="row text-center pt-3">
                <div class="col-md-3">
                    ...
                    <p class="content">Thời gian giao hàng linh động từ 3 - 4 - 5 ngày tùy khu vực, đôi khi sẽ nhanh hơn hoặc chậm hơn. Mong Quý Khách hàng thông cảm và cố gắng đợi hàng giúp shop.</p>
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <p class="content">Sản phẩm được phép đổi hàng trong vòng 36h nếu phát sinh lỗi từ nhà sản xuất &#40;Yêu cầu: hình ảnh phần bị lỗi rõ nét, chi tiết và đầy đủ&#41;.</p>
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <p class="content">Được phép kiểm hàng trước khi thanh toán. Lưu ý: Trường hợp Quý Khách hàng đã nhận hàng về nhà, vui lòng quay video unbox đơn hàng trong tình trạng nguyên vẹn để có căn cứ xác thực đơn hàng gặp phải vấn đề, trường hợp không có video shop không thể hỗ trợ.</p>
                </div>
                ...
                <div class="row">
                    <div class="col-md-3 py-2">
                        <div className="card rounded-0">
                            <a href=""><img className="card-img rounded-0 img-fluid" src="https://theme.hstatic.net/200000305259/1000967293/14/banner_index_1.jpg?v=12"/></a>
                        </div>
                    </div>

                    <div class="col-md-3 py-2">
                        <div className="card rounded-0">
                            <a href=""><img className="card-img rounded-0 img-fluid" src="https://theme.hstatic.net/200000305259/1000967293/14/banner_index_2.jpg?v=12"/></a>
                        </div>
                    </div>

                    <div class="col-md-3 py-2">
                        <div className="card rounded-0">
                            <a href=""><img className="card-img rounded-0 img-fluid" src="https://theme.hstatic.net/200000305259/1000967293/14/banner_index_3.jpg?v=12"/></a>
                        </div>
                    </div>

                    <div class="col-md-3 py-2">
                        <div className="card rounded-0">
                            <a href=""><img className="card-img rounded-0 img-fluid" src="https://theme.hstatic.net/200000305259/1000967293/14/banner_index_4.jpg?v=12"/></a>
                        </div>
                    </div>

                    <div class="col-md-3 py-2">
                        <div className="card rounded-0">
                            <a href=""><img className="card-img rounded-0 img-fluid" src="https://theme.hstatic.net/200000305259/1000967293/14/banner_index_5.jpg?v=12"/></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section>
            <div class="container py-5">
                ...
                <div className="row">
                    ...
                    <a href=""><button type="button" class="btn btn-outline-primary">Xem tất cả</button></a>
                </div>
                </div>
            </div>
        </section>
