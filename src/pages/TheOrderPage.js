                ...
                <div className="table-responsive block-left  ms-2">
                    ...
                    <div className="field field_v1 ms-4">
                        ...
                        <input id="nameReceiver"
                          ...
                          onChange={changeName}     className="field__input" placeholder=" "></input>
                    ...
                    <div className="field field_v1 ms-4">
                        ...
                        <input id="phoneReceiver" defaultValue={phoneReceiver} className="field__input" onChange={changePhone}
                               placeholder=" "></input>
                        <span className="field__label-wrap" aria-hidden="true">
                    ...
                    <div className="row mb-3">
                        ...
                        <div className="field field_v1 ms-3 col">
                            ...
                            <select className="field__input" placeholder=" " onChange={changeWard}>
                ...
                <div className="table-responsive block-right ">
                    ...
                    <div className="shopping-cart-footer">
                        <div className="col-10 mt-3 mb-3 m-auto">
                            <button className="btn btn-success w-100" onClick={handleConfirmOrder}> Đặt hàng </button>
                        </div>
                    </div>
                </div>
            </div>
