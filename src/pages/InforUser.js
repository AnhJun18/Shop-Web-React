...
const InforUser = () => {
    ...
    return <>
          <div class="margin-left-right padding-bottom-3x marginTop marginBot row">
                ...
                <button className={status==1? " buttonHead active": " buttonHead"} onClick={clickInfor}>Hồ sơ của tôi</button>
                <button className={status==2? " buttonHead mb-3 active": " buttonHead mb-3"} onClick={clickTheOrder}>Đơn đặt hàng</button>
                </div> 
                <div class="table-responsive block-infor-right ">
                    {
                        ...
                        <div className="row mb-3 ms-3 me-3 borderr">
                            ...
                            <div className="display-flex">
                                ...
                                <input type="radio" value="Nam" name="fav_language" className="me-2 mt-3 ms-5"></input>
                                <label for="nam" className="mt-3">Nam</label>
                                <input type="radio" value="Nu" name="fav_language" className="me-2 ms-4 mt-3"></input>
                        ...
                        // Quảng lý đơn hàng
                        <div>
                            <button className={tmp==1? " buttonStatus active me-1 ms-2": " buttonStatus me-1 ms-2"} onClick={clickConfirmation}>Chờ xác nhận</button>
                            <button className={tmp==2? " buttonStatus active me-1": " buttonStatus me-1"} onClick={clickPreparing}>Chuẩn bị hàng</button>
                            <button className={tmp==3? " buttonStatus active me-1": " buttonStatus me-1"} onClick={clickDelivery}>Đang vận chuyển</button>
                            <button className={tmp==4? " buttonStatus active me-1": " buttonStatus me-1"} onClick={clickDelivered}>Đã giao</button>
                            <button className={tmp==5? " buttonStatus active me-1": " buttonStatus me-1"} onClick={clickCancelled}>Đã hủy</button>
                            {
                                emty?
                                <div>
                                ...
                                <div>
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td>
                                                <div className=" display-flex">
                                                    <a className="" href="#"><img className="imageInfor" src={require('./../assets/images/banner_img_02.jpg')} alt="Product"/></a>
